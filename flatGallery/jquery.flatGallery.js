        ...
        var galleryViews = function(){
            return '<div class="displaySelector both cool"> '+
                ...
                '<div class="viewButtons right">'+
                    '<div class="viewList viewButton button left" alt="list" >List<img src="../flatGallery/iconList.png" width="18" /></div>'+
                    '<div class="viewThumb viewButton button left" alt="thumb" >Thumb<img src="../flatGallery/iconThumbs.png" width="18" /></div>'+
                '</div>'+
            '</div>';
        };
